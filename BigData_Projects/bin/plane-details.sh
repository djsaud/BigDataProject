...
# DESC : THIS SCRIPT POPULATES THE PLANE DATA AND STORE IN AVRO    #
# CREATE DATE :                                                    #
# MODIFIED DATE :                                                  #
# MODIFIED DESC :                                                  #
####################################################################
...
info "bash $PIG_HOME/plane-details.sh"
info "-q default -t plane-data -i /user/cloudera/testAirline/data/plane-data.csv"
info "-b /home/cloudera/Desktop/Spark-Kafka-UseCase -n BigData_Projects-1.0-SNAPSHOT_java7.jar "
info "-o /user/cloudera/testAirline/outdata/plane-data_test "
...
info "executePig -useHCatalog  -param INPUT_PATH=${INPUT_PATH} -param OUTPUT_PATH=${OUTPUT_PATH} -f ${PIG_HOME}/plane-details.pig "


executePig -useHCatalog  -param INPUT_PATH=${INPUT_PATH} -param OUTPUT_PATH=${OUTPUT_PATH} -f ${PIG_HOME}/plane-details.pig
