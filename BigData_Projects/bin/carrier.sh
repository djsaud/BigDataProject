...
# DESC : THIS SCRIPT POPULATES THE CARRIER DATA AND STORE IN AVRO  #
# CREATE DATE :                                                    #
# MODIFIED DATE :                                                  #
# MODIFIED DESC :                                                  #
####################################################################
...
info "bash $PIG_HOME/carrier.sh"
info "-q default -t carrier -i /user/cloudera/testAirline/data/carrier.csv"
info "-b /home/cloudera/Desktop/Spark-Kafka-UseCase -n BigData_Projects-1.0-SNAPSHOT_java7.jar "
info "-o /user/cloudera/testAirline/outdata/carrier_test "
...
info "executePig -useHCatalog  -param INPUT_PATH=${INPUT_PATH} -param OUTPUT_PATH=${OUTPUT_PATH} -f ${PIG_HOME}/carrier.pig "


executePig -useHCatalog  -param INPUT_PATH=${INPUT_PATH} -param OUTPUT_PATH=${OUTPUT_PATH} -f ${PIG_HOME}/carrier.pig
